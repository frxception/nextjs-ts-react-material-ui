...
Static rendered hotel view will use the provided params and arguments (SGD, CNY, USD, KRW)
 *  /api/hotels/<hotel_id>?partnerId=1&currency=<currency_name> 
